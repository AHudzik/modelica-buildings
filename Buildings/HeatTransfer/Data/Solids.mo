...
First implementation.
  ...
  record ConcreteHM =  Buildings.HeatTransfer.Data.Solids.GenericHM (
      ...
      sorp_tab_layer =        {{0.0,   0.0},
                                      ...
                                      {0.95,  118.0},
                                      {1.0,   150.0}},
      dws_tab_layer =       [   0.0,   1.0e-16;
                                       72.0,  7.4e-11;
                                       85.0,  2.5e-10;
                                       100.0, 1.0e-9;
                                       118.0, 1.2e-9],
      dww_tab_layer =       [   0.0,   1.0e-16;
                                       72.0,  7.4e-12;
                                       85.0,  2.5e-11;
                                       100.0, 1.0e-10;
                                       118.0, 1.2e-10],
       my_tab_layer =     [  0.0, 180;  1.0, 180],
       lamb_tab_layer =     [   0.0,    1.6;
                                       180,    1.6]);
